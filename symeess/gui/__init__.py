...
class Example(QWidget):
    ...
    def initUI(self):
        ...
        central_atom_name.move(350, 50)
        central_atom = QLineEdit(self)
        central_atom.move(450, 50)
