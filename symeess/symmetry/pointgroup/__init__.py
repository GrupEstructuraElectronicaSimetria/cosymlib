import itertools
import numpy as np
from symeess.symmetry.pointgroup.operations import inversion, rotation_matrix, reflection
from symeess.symmetry.pointgroup import sym_tools
...
class CalculatePointGroup:
    ...
    def __init__(self, geometry, tolerance=0.01, tol=0.3):
        ...
        self.rot_sym = []
        self._max_order = ''
        self._cent_coord = geometry.get_positions() - sym_tools.get_center_mass(self._symbols, geometry.get_positions())
    ...
    def get_centerd_coordinates(self):
